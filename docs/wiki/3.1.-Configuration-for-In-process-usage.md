...
_For example, you want to apply caching for [Request](Home.md#request) responses which should not affect messages. On the other hand, you want to audit all messages sent through a mediator, but do not want to audit Requests._
