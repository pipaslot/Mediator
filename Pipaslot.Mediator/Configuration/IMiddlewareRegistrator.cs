...
namespace Pipaslot.Mediator.Configuration
{
    ...
    public interface IMiddlewareRegistrator
    {
        ...
        IMiddlewareRegistrator Use<TMiddleware>(ServiceLifetime lifetime = ServiceLifetime.Scoped, object[]? parameters = null) where TMiddleware : IMediatorMiddleware;
        ...
        /// <param name="lifetime">Middleware lifetime set on service collection</param>
        /// <param name="parameters">Parameters passed to <see cref="MediatorContext.Features"/> right before middleware execution and available under type <see cref="MiddlewareParametersFeature"/></param>
        IMiddlewareRegistrator Use<TMiddleware>(Action<IServiceCollection> setupDependencies, ServiceLifetime lifetime = ServiceLifetime.Scoped, object[]? parameters = null) where TMiddleware : IMediatorMiddleware;
