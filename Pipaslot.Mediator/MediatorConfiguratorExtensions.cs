...
namespace Pipaslot.Mediator
{
    public static class MediatorConfiguratorExtensions
    {
        ...
        /// </summary>
        public static IMediatorConfigurator AddPipelineForActions(this IMediatorConfigurator configurator, Action<IMiddlewareRegistrator> subMiddlewares, params Type[] actionTypes)
        {
        ...
        /// </summary>
        public static IMediatorConfigurator AddPipelineForActions<TActionMarker1, TActionMarker2>(this IMediatorConfigurator configurator, Action<IMiddlewareRegistrator> subMiddlewares)
        {
        ...
        /// Register action-specific pipeline with separated middlewares applied only for actions implementing any TActionMarker.
        /// </summary>
        public static IMediatorConfigurator AddPipelineForActions<TActionMarker1, TActionMarker2, TActionMarker3>(this IMediatorConfigurator configurator, Action<IMiddlewareRegistrator> subMiddlewares)
        {
