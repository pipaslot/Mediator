...
namespace Pipaslot.Mediator.Tests.Authorization
{
    public class RuleSet_GetRuleOutcomeTests
    {
        ...
        [InlineData(new[] { RuleOutcome.Ignored, RuleOutcome.Ignored }, Operator.And, RuleOutcome.Ignored)]
        ...
        [InlineData(new[] { RuleOutcome.Unavailable, RuleOutcome.Deny, RuleOutcome.Ignored }, Operator.Or, RuleOutcome.Deny)]// Return the value more close to alowed status
